...
def createFsLayerByFy(fy):
    fy_layers = []
    src_folder = r'/home/ben/DITT/Central_Australia_Fire_Mapping/Fire_Scars_Archive/Fixed'
    ...
    for m in months1:
        ...
        for ft in month_fires1:
            ...
            if not g1_in_study_area.isEmpty():
    ...
    for m in months2:
        ...
        for ft in month_fires2:
            ...
            if not g2_in_study_area.isEmpty():
    ...
    output_folder = r'/home/ben/DITT/Central_Australia_Fire_Mapping/Sth_NT_Fire_Scars_by_FY/Fixed'
